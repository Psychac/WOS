...
Weight: 54 kg
Build: Slim
Shoulder Width: Slightly narrow-average
...
It should avoid projecting:

Flashiness
Trend dependence
Excessive streetwear influence
Corporate stiffness
Loud luxury
...
Produces cohesive outfits with minimal effort.
Functions across office, casual and social settings.
...
Fulfil a clearly defined role.
Work with multiple existing pieces.
Strengthen the overall wardrobe rather than exist independently.
